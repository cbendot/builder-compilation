...
# Kernel Sources
git clone --depth=1 https://github.com/cbendot/kernel_asus_sdm660.git -b msm-4.4-eas kernel
git clone --depth=1 https://gitlab.com/crdroidandroid/android_prebuilts_clang_host_linux-x86_clang-r445002.git -b 12.1 clang
# git clone --depth=1 https://gitlab.com/ben863/aosp-clang.git clang
# git clone --depth=1 https://gitlab.com/ben863/azure-clang.git clang
